...
const bookSchema = new mongoose.Schema({
    name: {
        ...
        trim: true,
        maxLength: [30, 'Book name must be less than 30 characters'],
    ...
    isbn: {
        ...
        trim: true,
        maxLength: [30, 'Book isbn must be less than 30 characters'],
    ...
    price: {
        ...
        trim: true,
        maxLength: [30, 'Book price must be less than 30 characters'],
